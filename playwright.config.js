  ...
  projects: [
    {
      ...
      testMatch: /(atlas-widget|smoke|auth-helper|consolidator|i18n|pocket-story|investigations|investigation-stories|investigation-viz|permissions-matrix|dossiers|data-studio|articles|translations)\.spec\.js$/,

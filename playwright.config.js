...
export default defineConfig({
  ...
  use: {
    ...
    // When PLAYWRIGHT_PROXY is set (e.g. the DAST runner pointing at
    // the ZAP container), funnel every browser request through it so
    // ZAP gets to passively scan the same traffic the smoke suite
    // generates. Unset on prod / dev runs — direct connections.
